                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="float-right">
                                ...
                                <a href="{{route('tarefa.exportacao', ['extensao' => 'xlsx'])}}" class="me-5">XLSX</a>
                                <a href="{{route('tarefa.exportacao', ['extensao' => 'csv'])}}" class="me-5">CSV</a>
                                {{-- <a href="{{route('tarefa.exportacao', ['extensao' => 'pdf'])}}" class="me-5">PDF</a> --}}
